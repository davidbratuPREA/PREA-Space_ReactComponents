...
export function DemoPage() {
  ...
  return (
    <div className="comp-page comp-page--full demo-page">
      ...
      <p className="demo-page__caption">{screen.caption} · Full HD 1920 × 1080 at 1:1</p>
